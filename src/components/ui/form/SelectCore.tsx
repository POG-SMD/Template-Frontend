...
>(({ className, children, error, icon = 'mi:select', ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-md border border-slate-700 bg-transparent px-3 py-2 ring-primary ring-inset placeholder:text-slate-500 focus:outline-none focus:ring-1 focus:border-primary disabled:cursor-not-allowed disabled:opacity-70 [&>span]:line-clamp-1 dark:border-slate-800 dark:bg-transparent dark:placeholder:text-slate-400 dark:text-slate-50 group',
      className,
